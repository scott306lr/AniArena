...
describe('Arena Test', () => {
  ...
  beforeEach( () => {
    ...
    status_state = new State(9999, "status", 5, "NORM", "NONE", {"HP": 100, "AP": 100}, [], ["status"]);
  ...
  it.todo('EffectQueue.run() returns the modified states correctly.');
  it.todo('EffectQueue.run() logs correctly.')
